...
export default function HeaderList() {
  ...
  return (
    <div className="sm:container w-full pb-4 overflow-scroll scrollbar-hide px-3 md:px-0 flex space-x-6 sm:space-x-8 md:space-x-10 items-center justify-center">
